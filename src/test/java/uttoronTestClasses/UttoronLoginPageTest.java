...
public class UttoronLoginPageTest extends UttoronBrowserOpen_Quit {
	...
	@Test(priority = 1)
	public void UserLoginByValid() throws EncryptedDocumentException, IOException, InterruptedException {
...
//		ul.Loginpage_LoginButton();
	...
	@Test(priority = 2)
	public void UserLoginByInValid() throws EncryptedDocumentException, IOException, InterruptedException {
